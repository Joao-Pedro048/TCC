...
**ShopEngine** - Elementor WooCommerce Builder Addons. Comes with WooCommerce Template Builder, WooCommerce Single Builder, WooCommerce Products Comparison Table, Custom WooCommerce Product Template Builder, Woo Product Category, WooCommerce Category Showcase, WooCommerce Quick View, Woo Wishlist, WooCommerce Cart, WooCommerce Checkout, WooCommerce Rating, WooCommerce Product Size, WooCommerce Product SKU, WooCommerce Sales Notification, WooCommerce Ajax Search, WooCommerce Sticky Add to Cart, WooCommerce  Cart Page Builder, WooCommerce Shop Page Builder,  WooCommerce Product Filter,   WooCommerce Product Share, WooCommerce Product Grid, Woo WooCommerce Responsive Grid, WooCommerce WooCommerce Product List, WooCommerce WooCommerce Product Sort, WooCommerce Recently Viewed Products, WooCommerce Discount Schedule Counter, WooCommerce Template Library, WooCommerce Product Reviews, WooCommerce Product Carousel, WooCommerce Product Slider, Woo Archive Page with Pagination, WooCommerce Upsell, WooCommerce Cross-sell, WooCommerce Suggest Product Price, WooCommerce Call for Price Button, WooCommerce Variation Swatches Module and Multi-language Support system

== Description ==

Are you using multiple plugins for features like Multi-language Supported WooCommerce builder, Elementor addons, compatible with Free Elementor and WooCommerce, WooCommerce shop pages, custom WooCommerce product template builder, cart page builder, WooCommerce product wishlist, product comparison button, products comparison table, WooCommerce product quick view modals, upsell products,  WooCommerce preorder, and WooCommerce Variation Swatches?

Well, not anymore! You don’t have to slow down your eCommerce website. Enjoy all the **functionalities of a full-fledged online shop** with custom WooCommerce product template builder that works with Free Elementor and WooCommerce **without affecting loading speed** and also have deep customization option using **drag and drop WooCommerce template builder**, **[ShopEngine](https://wpmet.com/plugin/shopengine)**. Harness the power of Elementor inside your WooCommerce website!

If you are a WooCommerce product designer, then you can also get advantages from ShopEngine WooCommerce template builder. Because ShopEngine WooCommerce template builder will let you add any Woo feature as well as change and upload or share product images anytime. 

To cut a long story short, ShopEngine WooCommerce template builder facilitates WooCommerce product designers to a great extent.

[ShopEngine Landing Page](http://wpmet.com/plugin/shopengine/) | [Support](http://account.wpmet.com/support-help/) | [Docs](https://wpmet.com/doc/getting-started-with-shopengine-installation/) | [Request a Feature](https://wpmet.com/plugin/shopengine/roadmaps#ideas)
...
### ShopEngine at a Glance:

ShopEngine is the most complete WooCommerce template builder for Elementor. It works with Free Elementor and WooCommerce efficiently. At the same time, it's a Multi-language supported builder for your WooCommerce store.

ShopEngine (Elementor WooCommerce Builder) helps you create single page builder templates as well as shop page builder templates. 

Not only that, this dynamic and drag-and-drop WooCommerce template builder will help you to customize the single product page as well as the entire shop page. 

You can also design and customize the other essential pages for WooCommerce websites. For example, you can build an order page, cart page, and checkout page for your WooCommerce store using ShopEngine (Woo Builder). 

Apart from these, you can design a dynamic archive page with pagination. Plus, my account page, and thank you page from scratch are also available in the ShopEngine widget list. 

Along with the product comparison, WooCommerce product wishlist, WooCommerce Category Showcase, WooCommerce Quickview for products, WooCommerce variation swatches, WooCommerce preorder, ShopEngine WooCommerce template also offers **70+ drag-and-drop Elementor widgets**. These widgets will let you build and customize your eCommerce website to your heart’s content. 

Besides, you can add suggested product prices to your website. You can also edit product pages easily using the ShopEngine Elementor WooCommerce builder.

With the combination of the ShopEngine WooCommerce template builder and eCommerce themes, you can create a storefront menu for your store too.

In addition, you can utilize the custom WooCommerce product template builder as well as the Gutenberg WooCommerce blocks of ShopEngine.

### 👉 ShopEngine Elementor WooCommerce Woo Builder Includes:
#### 🔥 WOOCOMMERCE GUTENBERG BLOCKS ADDON IS NOW AVAILABLE!

**⭐ Elementor** WooCommerce Builder
**⭐ 20+ Essential** WooCommerce Modules
**⭐ 70+ WooCommerce widgets**
**⭐ Override WooCommerce pages** like Single page builder, Shop Page Builder Cart, Checkout page, etc
...
**⭐** WooCommerce  **Product Quick View**/Quick View WooCommerce
**⭐** Products  **Comparison Table**/Woocommerce Product Compare
**⭐** WooCommerce Product  **Wishlist Module**
...
**⭐**Free WordPress **Gutenberg Blocks**/Gutenberg WooCommerce blocks
**⭐** No **Coding Skills **Required**
**⭐** Display **Related Products** Smartly
**⭐** Top-notch and **Dedicated Support Team**

==❤️ **Free WooCommerce Widgets:** ==
👉 Product Review WooCommerce Widget
👉 Product Share WooCommerce Widget
👉 Breadcrumbs WooCommerce Widget
👉 Product Categories WooCommerce Widget
👉 Related Products WooCommerce Widget
👉 View Single Product WooCommerce Widget
👉 Notice WooCommerce Widget
👉 Cart Table WooCommerce Widget
👉 Cart Total WooCommerce Widget
👉 Cross-Sell WooCommerce Widget
👉 Return to Shop WooCommerce Widget
👉 Empty Cart Message WooCommerce Widget
👉 Archive Description WooCommerce Widget 
👉 Archive Products WooCommerce Widget
👉 Archive Result Count WooCommerce Widget
👉 Archive View Mode WooCommerce Widget
👉 Order By Filter WooCommerce Widget
👉 Product List WooCommerce Widget
👉 Checkout Payment WooCommerce Widget
👉 Order Review WooCommerce Widget
👉 Checkout Form - Additional WooCommerce Widget
👉 Checkout Form - Coupon WooCommerce Widget
👉 Checkout Form - Billing WooCommerce Widget
👉 Checkout Form - Login WooCommerce Widget
👉 Checkout Form - Shipping WooCommerce Widget
👉 Checkout Shipping Methods WooCommerce Widget
👉 Advanced Search WooCommerce Widget
👉 Deal Products WooCommerce Widget
👉 Filterable Product List WooCommerce Widget
👉 Product Category List WooCommerce Widget
👉 Recently Viewed Products WooCommerce Widget

==🔥 **Premium WooCommerce Widgets:** ==
➡️ Product Size Chart WooCommerce Widget
➡️ Product Filters WooCommerce Widget
➡️ Checkout Order pay WooCommerce Widget
➡️ Order Details WooCommerce Widget
➡️ Thank You Address Details WooCommerce Widget
➡️ Order Confirm WooCommerce Widget
➡️ Order Thank You WooCommerce Widget
➡️ Account Address WooCommerce Widget
➡️ Account Dashboard WooCommerce Widget
➡️ Account Navigation WooCommerce Widget
➡️ Account Orders WooCommerce Widget
➡️ Account Order - Details WooCommerce Widget
➡️ Account Downloads WooCommerce Widget
➡️ Account Logout WooCommerce Widget
➡️ Account Details WooCommerce Widget
➡️ Account Form Login WooCommerce Widget
➡️ Account Register Form WooCommerce Widget
➡️ Avatar WooCommerce Widget
➡️ Categories WooCommerce Widget
➡️ Currency Switcher WooCommerce Widget
➡️ Flash Sale Products WooCommerce Widget
➡️ Best Selling Products WooCommerce Widget
➡️ Comparison Button WooCommerce Widget
➡️ Advanced Coupon WooCommerce Widget
➡️ Vacation WooCommerce Widget

### ✨ SHOPENGINE WOOCOMMERCE MODULES
...
**WooCommerce Quick view module** of the ShopEngine Elementor WooCommerce builder will let the customers have a glance at any product of your online shop without entering the individual product page.

WooCommerce product quick view is one of the widely used WooCommerce extensions for WooCommerce shops.

ShopEngine WooCommerce template builder displays a product lightbox or product modal that pops up with a product image and short description when a customer clicks on the WooCommerce Quickview button of the product. Apart from enabling/disabling the WooCommerce Quickview module, you can change every featured element from top to bottom for your WooCommerce product's quick view using this WooCommerce template builder's module. 

Besides, using this free WooCommerce quick view feature with Elementor page builder, you have the wizard to decide how you want your customers to interact with the product. Besides, the admin can view all quick orders after utilizing this WooCommerce Quickview module.

This WooCommerce product quick view for WooCommerce module will also save your customers’ time and let them have a quick product view. Also, the customization option is fully open for the WooCommerce product quick view module. Using this WooCommerce product's quick view module unlocks the best shopping assistance title for a shop. 

So, let your customers do shopping in the shortest possible time with this WooCommerce product's quick view module.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/quick-view/)

### VARIATION SWATCHES MODULE

Let the Buyers Specify the Desired Product with Product Variation Swatches

**WooCommerce Variation Swatches** of this Elementor WooCommerce builder add-on enable the shoppers to select attributes for variation products.

With product variation swatches module of the ShopEngine WooCommerce template builder, you can turn the product variation option fields into radio images, labels, and colors. This Elementor WooCommerce builder module helps to drop the dropdown product attribute fields from your website. 

Apart from customizing the border and background sizes, you can easily enable and disable this module whenever you want by this dynamic Elementor WooCommerce builder. So, switch to variation swatches and turn the product variation select option fields into something more stylish and eye-catching. So, say hello to variation swatches for WooCommerce.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/variation-swatches/)

### WISHLIST MODULE

Let the Buyers Add Products to the Woo Wishlist

A **WooCommerce Product Wishlist** lets the shoppers save their desired products to buy later on.

As an e-commerce shop owner, you should make sure that you’ve added a functional WooCommerce Product Wishlist button with every product.

Integrating the WooCommerce Product Wishlist module of the ShopEngine Elementor WooCommerce builder add-on in your shop has multiple benefits. 

Leveraging this feature of the WooCommerce Product Wishlist, shoppers can save any products for buying in the future. When they come back to your website later adding products to the Woo wishlist, they can easily track the products on the list and add them to the cart for buying.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/product-wishlist/)

### PRODUCT COMPARISON MODULE

Let the Buyers Compare Products Side By Side including comparing prices, offers, features, etc.

The **product comparison button module for WooCommerce** module of the ShopEngine Elementor WooCommerce builder will enable the buyers to compare the WooCommerce products of your shop with a compare table.

You can set an add-to-compare button to help them see the product differences from a custom compare page. They will have absolute liberty to select attributes for creating WooCommerce products comparison table. 

With this outstanding WooCommerce product-compare module of the ShopEngine Elementor WooCommerce builder, you can customize the compare buttons using the widget settings from Elementor.

Furthermore, because of this WooCommerce compare products plugin, you can help your customers to choose the best product by showing a products comparison table. Apart from this, with the WooCommerce compare products plugin of the ShopEngine WooCommerce template builder, you can ease your customers' shopping experience.

Again, comparison products will be presented through a products comparison table that let your customer compare prices and offers of the products. 

Lastly, you can customize everything on your products comparison table with this WooCommerce compare products plugin using this Elementor WooCommerce builder add-on.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/product-comparison/)

### BADGES MODULE [PRO]

Let your customers know about the sale of products that are running on special days by using ShopEngine’s **badges module**.

This WooCommerce Elementor module of ShopEngine will show the percentage of discounts with a discount schedule counter you are giving for different products on special days. With this module of the ShopEngine WooCommerce template builder, you can attract your customers more as people love to buy products during offers.
...
👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/badges/)

### QUICK CHECKOUT MODULE [PRO]

Provide your customers with a quick checkout option that will save your customers time.

ShopEngine WooCommerce template builder offers a quick checkout option for your eCommerce store that redirects to the Shopify style checkout page. You can add a single product cart button to the product with this module which will redirect your customers to the checkout page.

 A direct redirect to the Shopify-like Checkout will help your customers skip the shopping Cart page builder and directly visit the Shopify style checkout page for a fast checkout facility.

The **quick checkout module** of this outstanding Elementor WooCommerce builder will ease your checkout option and help your customers get the best shopping experience by saving their time by instantly redirecting them to the Shopify-like Checkout. It will also reduce WooCommerce cart abandonment by adding a single product cart button.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/quick-checkout/)

### PARTIAL PAYMENT MODULE [PRO]

Let your customers pay their payments partially.

This WooCommerce Elementor module will boost your conversion rate by adding a **partial payment system** to each of your shared products. Because of this option, customers who can’t buy because of a lack of money can get the product. Also, You can boost customer satisfaction by offering this option.
...
This will optimize your Shop page builder and boost sales  using the Sticky Add to Cart widget by reducing WooCommerce cart abandonment.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/partial-payment/)
...
The **Pre-order module** of the ShopEngine WooCommerce template builder will let you add a pre-order option to your products. As a result, you will get the exact idea of the market demand for your  products. Besides, you can earn revenue in an advance through early WooCommerce orders.

ShopEngine Elementor WooCommerce builder not only helps you to add pre-order options but also helps you to customize this WooCommerce preorder option. So that your pre-order button will be more eye-catching and help you to boost conversions.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/pre-order/)

### BACK-ORDER MODULE [PRO]

This WooCommerce Elementor module will let you add a back-order option to your products. As a result, you can take WooCommerce orders from your customers after the stockout of your products.

ShopEngine’s **back-order feature** will help you to know, whether you should stock the WooCommerce ordered products again or not. Besides, you can increase customer satisfaction by prioritizing your customer’s demands by restocking WooCommerce ordered products.

Making the back-order option more appealing is possible with the ShopEngine WooCommerce template builder. Also, you will get tons of customization options in this Elementor WooCommerce builder.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/backorder/)

### SALES NOTIFICATION MODULE [PRO]

Make a high social proof site with the sales notification module of ShopEngine.

**Sales notification** module will let you add notifications for your recent product sales through a popup. This WooCommerce Live Sales Notifications popup section will showcase the recent orders, including customer name, address, purchased products, image, and purchase time. When a visitor enters your site, they will see notifications of your sales. 

Adding WooCommerce Live/custom Sales Notifications module of the ShopEngine Elementor WooCommerce builder add-on will help your customers to buy your products by increasing trust. You can also create a sense of urgency and reduce WooCommerce cart abandonment through this WooCommerce Live Sales Notifications module.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/sales-notification/)

### CURRENCY SWITCHER MODULE [PRO]

Switch Currency according to your market demand and expand your business.

ShopEngine Elementor WooCommerce builder provides a **currency switcher module** to switch currency according to your needs. This is an effective tool for your eCommerce store. You can also show multiple currencies for customers who belong to different countries.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/currency-switcher/)

### FLASH SALE COUNTDOWN MODULE [PRO]

ShopEngine sales countdown WooCommerce addon will give your customers offers and discounts with discount schedule counter for a specific time a flash bar and let your customers know the time of that offer with this module.


The **Flash sale countdown module** will help your customers act immediately as offer time is limited for adding products with discount schedule counter. ShopEngine WooCommerce template builder will help you to increase your conversion rate with this sales countdown WooCommerce module. This sales countdown WooCommerce module helps you to offer a flash sale module that provides unique design templates for the flash bar.

You will also get different styles to show your count-down timer to your customers by using this Elementor WooCommerce builder add-on. Further, a 100% customization option is also open for every property of this sales countdown WooCommerce module that can make your offers on special days more attractive.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/flash-sale-countdown/)

### ADDITIONAL CHECKOUT FIELDS MODULE [PRO]

Add and remove fields from your checkout form according to your needs with this module.

The **additional checkout field module** of this Elementor WooCommerce builder add-on will let you add new fields to your checkout form and remove it when it has no use. As a result, you can give your checkout form a professional look and get information from your customers according to your needs.

👉 [Find out more...](https://wpmet.com/plugin/shopengine/modules/additional-checkout-fields/)

### Product Size Charts (Pro)
...
👉 [Find out more...](https://wpmet.com/doc/product-size-charts-module/)

### Sticky Fly Cart (Pro)

This **sticky fly cart module** is also known as Sticky Add to Cart for WooCommerce websites. Enabling  this module will add a floating cart to your eCommerce store. This Sticky Add to Cart feature of this Elementor WooCommerce builder allows your customers to view their added products to the cart without visiting the Cart page builder section. 
...
From this sticky fly cart or Sticky Add to Cart module, your customers can view all products. Also, customer can also add/remove items, see the subtotal amount and as well as navigate checkout process too from this Sticky Add to Cart section. 

Again, you can customize this Sticky Add to Cart for making the quick cart more attractive. Moreover, adding Sticky Add to Cart with your WooCommerce website will save time and help the users to see all details of their cart section without loading the whole website. 
...
👉 [Find out more...](https://wpmet.com/doc/sticky-fly-cart/)
...
👉 [Find out more...](https://wpmet.com/doc/how-to-use-shopengine-vacation-module/)

### Multistep Checkout (Pro)
...
👉 [Find out more...](https://wpmet.com/doc/multistep-checkout/)


### Advanced Coupon (Pro)

Set up **coupons for specific states/regions of a country** using this Elementor WooCommerce builder add-on, so that, the use of this coupon will be limited. It will be valid only for that area. As a result, the customers of other countries can’t use that coupon.

👉 [Find out more...](https://wpmet.com/doc/shopengine-advanced-coupon-module/)

### Cross-Sell Popup (Pro)
...
👉 [Find out more...](https://wpmet.com/doc/shopengine-cross-sell-popup/)


### Avatar (PRO)

Make nice-looking user profiles by adding an **Avatar** to your WooCommerce website. This module allows users to place an image for their profile, add detailed information, and customize them with multiple options. 

However, you can add and configure the user avatar using the Account dashboard.  
...
👉 [Find out more...](https://wpmet.com/doc/woocommerce-avatar-module/)

### BUILD SINGLE PRODUCT PAGE WITH SHOPENGINE WOOCOMMERCE WIDGETS (FREE & PRO)

ShopEngine offers **20+ WooCommerce Elementor Widgets** to build a product page that draws customers’ attention.

-   **[Product Price](https://wpmet.com/doc/product-price/):**  Customize the color, typography with unlimited color and font variations, and alignment of the suggested product price tag with this drag and drop Elementor widget.
    
-   **[Product Title](https://wpmet.com/doc/product-title/):** Showcase your title in different styles and colors and choose the best HTML tags for your share product’s title.
    
-   **[Product Rating](https://wpmet.com/doc/product-rating/):** Show the average rating of your product by ShopEngine’s rating widget. This will convince your customers to buy your products, and at the same time, your website will be social proof. Your customer will get an idea about the quality of your products through this rating widget.
    
-   **[Product Upsell](https://wpmet.com/doc/upsell/):** Leverage the WooCommerce Upsell widget feature to suggest more WooCommerce  upsell products to the shoppers in a versatile manner. You can set the number of WooCommerce upsell products to show, enable-disable WooCommerce slider layout, customize WooCommerce featured product slider, add promotional product slider, customize Woo sliders control options, show/hide heading, show/hide the regular price, suggest product price, show/hide the cart button, etc using this WooCommerce upsell widget. 
<br>Choose the number of slides to be shown in the viewport of your WooCommerce upsell products. Using the WooCommerce upsell widget of ShopEngine, you can customize the slide speed, arrows size, dots size, active dots size, etc. Turn the loop and autoplay on and off as required for your WooCommerce upsell products.
    
-   **[Product Additional Information](https://wpmet.com/doc/additional-information/):** Give your shoppers more information about the products. Customize the title, rename the labels, value, table, and typography from the settings for your share products.
    
-   **[Add to Cart](https://wpmet.com/doc/add-to-cart/):** Design your add-to-cart button as per your own fashion and let the shoppers add any products they want to buy in just one click. Change the colors, layout, style, hover effect, and place the single product cart button in any position you want. Build the finest single product cart button with this widget.
    
-   **[Product Meta](https://wpmet.com/doc/product-meta/):** Let you show or hide the product SKU, product category, and product tag on your product page.
    
-   **[Product Description](https://wpmet.com/doc/product-description/):** Decide how you want to show the detailed description of the product features with the product description widget for WooCommerce.
    
-   **[Product Excerpt](https://wpmet.com/doc/product-excerpt/):** Get the best of the product excerpt widget for busy customers to describe a product in a nutshell.
    
-   **[Product Images](https://wpmet.com/doc/product-image/):** Find the right icon for the product lightbox. Show/hide the sale flash. Make changes to the color, and typography with unlimited color and font variations, image position, border type, border radius, etc. from the sale flash, lightbox zoom icon, and image style settings. Zoom WooCommerce product images as your requirement. As a result, your customers can have a good look at your zoom WooCommerce products.
...
-   **[Product Tags](https://wpmet.com/doc/product-tags/):** Customize the product tag label, rename the label, alignment, and customize WooCommerce buttons typography and color with unlimited color and font variations. Show/hide the tags as well as add hover effects of your choice.
...
-   **[Product Categories](Product%20Categories):** Show/hide the store products under the ‘product category label. You can also rename the label, and change the color, alignment, and typography with unlimited color and font variations until you are satisfied with your share product category using the WooCommerce Category Showcase widget of ShopEngine.
    
-   **[Product Tabs](https://wpmet.com/doc/product-tabs/):** Customize the WooCommerce Product Tab's navigation style, tab content, information list, review style, review form, and submit button.
    
-   **[Product Review](https://wpmet.com/doc/product-review/):**  This Product Reviews widget for WooCommerce allows you to set sticky reviews on your website. You can change the product review heading color and typography using the unlimited color and font variations, single review border type, color, and padding by using this Product Reviews widget for WooCommerce. Also, using this Product Reviews widget for WooCommerce, you can Customize the avatar width, review author name, review date, review content, review star color, empty star color, and comment form.
    
-   **[Product Share](https://wpmet.com/doc/product-share/):** Display the product share widget to your customers in a lively manner. As a result, your customers can share products on their social media easily.
...
-   **[Related Products](https://wpmet.com/doc/related-products/):** Set the number of related products to show on your store by the WooCommerce Related Products Widget of ShopEngine (Woo Builder). You can set custom related products layout, as well as disable/remove/hide related products based on the requiremnets. 
Integrating the WooCommerce Related Products Widget will help your customers to get product recommendations with their searched products. As a result, your customers can choose the best products through product recommendations. 
<br>Besides, you can use the WooCommerce Related Products Widget to enable/disable the WooCommerce slider layout as well as set custom WooCommerce featured product slider, promotional product slider, and Woo slider control options. Choose to show/hide the heading, sale flash, regular price, suggested price, and cart button. Also, you can set the number of columns for the WooCommerce slider layout, and decide whether you want to use the loop or autoplay feature.  
<br>Moreover, you can set the preferred slide speed, arrow size, dots size, and active dots size by this WooCommerce Related Products Widget. Plus, the WooCommerce Related Products Widget of ShopEngine (Elementor WooCommerce builder) will help you to define whether the  products will be ordered randomly, by title, suggest price, popularity, rating, menu order, or menu order. Also, WooCommerce Related Products Widget will define the column gap, image height, background color, etc.

-   **[View Single Product](https://wpmet.com/doc/create-single-product-page/):** Display single products of your WooCommerce store along with the related information including title, image, suggested price, descriptions, etc. Also, you can navigate to the 'Add to Cart' and 'Buy Now' options from the View Single Product widget.

-   **[Notice](https://wpmet.com/doc/how-to-use-shopengine-vacation-module/):** Show a vacation notice on your site to make your customers aware of the off days when your customers can’t buy products from your store. With this widget, you set title, vacation message, holiday title, emergency title, emergency mail, etc for your notice. 
    
-   **[Product Size Chart (Pro)](https://wpmet.com/doc/product-size-charts-module/):** Add size charts to your products and customize them as your need. You can increase or reduce the size of the popup size chart with this widget along with lots of other customization.



### MODERNIZE CART PAGE BUILDER WITH SHOPENGINE WOOCOMMERCE WIDGETS

Get more sales by adding WooCommerce cross-sells and empty cart messages. Display a beautiful cart table with cart total and return to the shop button.
...
-   **[Cart Table](https://wpmet.com/doc/cart-table-widget/):** Customize the header, body, and footer of the product table with the cart table widget from ShopEngine Elementor WooCommerce builder. Add WooCommerce custom text  and set background color of the table header. Choose the vertical alignment in the top, middle, or bottom.  
   <br> Set the appropriate content padding, WooCommerce text color, suggested product price color, link hover color, content border type, etc. Set the button style in the table footer and customize anything else you want.
    
-   **[Cart Total](https://wpmet.com/doc/cart-total/):** Show/hide the cart total heading. Change the color and font size of the heading with unlimited color and font variations. Change the background color of the cart wrap and border type. Choose the color and typography for table data and shipping methods.  
    Select the table row border type and color. Add hover effects on the checkout button. Ensure good color combination and position of the box shadow.
    
-   **[Cross-Sell](https://wpmet.com/doc/cross-sell/):** Set the number of products to show for cross-sells. Bring variety in cross-sell product showcasing styles. Customize the WooCommerce featured slider, WooCommerce slider layout and Woo sliders control options. Decide to show/hide the sale flash, regular price, suggested price, cart button, and heading.
...
Choose to make the border shadow more attractive with horizontal, vertical, blur, and spread settings. This widget can convert your website to the best shopping assistance as customers can return products easily without any hassle.
    
-   **[Empty Cart Message](https://wpmet.com/doc/empty-cart-message/):** Display an empty cart message to the WooCommerce shoppers more intuitively with the customized style.
    

### SHOPENGINE WOOCOMMERCE WIDGETS TO MAKE AN INTUITIVE PRODUCT ARCHIVE PAGE

Customize the archive page with pagination, archive title, archive products, and archive description of your eCommerce website.

-   **[Archive Description](https://wpmet.com/doc/archive-description-widget/):** Alter the alignment, color, and typography of the archive description.
    
-   **[Archive Products](https://wpmet.com/doc/archive-products-widget/):** Change the archive product layout along with the styles of the product container, content, and sale flash with this widget. This edited WooCommerce product layout will make archive products more attractive.
    
-   **[Archive Title](https://wpmet.com/doc/archive-title-widget/):** Choose the right HTML tag for the archive title. Set the alignment, color, and typography as per your preference.
...
-   **[Product List](https://wpmet.com/doc/product-list/):** Add a list of your archive or WooCommerce Shop Page Builder product and customize it as your desire with ShopEngine’s WooCommerce Product List widget. This listing widget of the product archive page with pagination will let you select the number of products you want to show on a Single Page Builder. You can further customize product images, badges, categories, colors, ratings, etc with this widget.
    
-   **[Product Filters (Pro)](https://wpmet.com/doc/product-filters/):** Product Filters module let your customers filter out any specific WooCommerce Shop Page Builder / product archive page with pagination widget in the WooCommerce website. Product Filters  module of the ShopEngine Elementor WooCommerce builder works based on color, rating, size, and other attributes with the product filter widget. Also, the enable/disable the WooCommerce product gallery can be sorted out through this product filters module.
...
-   **[Checkout Payment](https://wpmet.com/doc/checkout-form-payment/):** Change the color of the alt WooCommerce text, URL, URL hover, and divider. Choose the container background color and padding value for the top, right, bottom, and left. Make any changes to the checkbox and customize WooCommerce CTA buttons color to let the shoppers have the best shopping experience.
    
-   **[Order Review](https://wpmet.com/doc/checkout-order-review/) :** Customize the border, typography, and customize WooCommerce buttons color as well as color of the table header, body, and footer with the checkout review order widget.
    
-   **[Checkout Form - Additional](https://wpmet.com/doc/checkout-form-additional/):** Bring changes to the form label or rename the label, and add WooCommerce custom text area styles with the checkout form additional widget.
...
-   **[Checkout Form - Login](https://wpmet.com/doc/checkout-form-login/):** Bring any changes in the toggle heading, rename the labels, set custom input, and button styles of the checkout form login.
    
-   **[Checkout Form - Shipping](https://wpmet.com/doc/checkout-form-shipping/):** Customize the checkbox title, form container, rename the labels, and input styles with the checkout form shipping widget.
    
-   **[Checkout Shipping Methods](https://wpmet.com/doc/checkout-shipping-methods/):** Display the shipping methods with distinctive colors, margin buttons, label spacing, etc.

- **[Checkout Order pay (Pro)](https://wpmet.com/doc/checkout-order-pay/):** Make an elegant partial due checkout section with tons of content and advanced customization options. You can change the color, background, typography, padding, border, etc for the table header, body, and footer of the WooCommerce checkout order pay form. 
Also, you can customize the properties of labels, checkboxes, and descriptions for the payment methods. Plus, there are multiple customization options for the order button and privacy & policy section.
...
-   **[Order Details (Pro)](https://wpmet.com/doc/order-details/):** Drag and drop the order details widget for Elementor to change the table header, table body, section headings, and wrapper styles.
...
### GENERAL SHOPENGINE WOOCOMMERCE WIDGETS FOR PAGE AND POSTS
...
-   **[Recently Viewed Products](https://wpmet.com/doc/recently-viewed-products/):** Add a recently viewed option to your eCommerce store using the Recently Viewed Products widget of the ShopEngine WooCommerce template builder. As a result, your customers can see the products they viewed a few times before. This Woo recently viewed products widget will help your customers easily find products and place WooCommerce orders.
...
-   **[Flash Sale Products (Pro)](https://wpmet.com/doc/flash-sale-products/):** Offer flash sales to your WooCommerce store on special days with the ShopEngine WooCommerce template builder’s flash sale product widget. This WooCommerce Elementor widget will let you give flash sales on different occasions and customize the layout of your flash sale products. Through this widget, you can present the flash sale on your share products. Besides, you can add a discount schedule counter to apply sales for products for a limited time using the Flash Sale Products widget. Plus, you can add a special day offer banner by inserting additional CSS.
...
-   **[Comparison Button (Pro):](https://wpmet.com/doc/product-comparison-module/)** Add comparison buttons for WooCommerce Product Comparison on your eCommerce website. Adding this widget for WooCommerce Product Comparison lets your customers compare different products. Your customer just needs to click on the WooCommerce Product Comparison to get a head-to-head WooCommerce Products Comparison Table with just one click. It will display a products comparison table for all properties. You can also rename the labels, edit icon settings, counter settings, and style of your WooCommerce Product Comparison with this widget.
...
You can also customize the style of the labels, inputs, buttons, and layouts of the Reset password form of ShopEngine Woo builder. Plus, you can add ElementsKit Conditions, effects, sticky as well as motion effects, and custom css with this WooCommerce reset password form widget.
...
-   **[Product Carousel (Pro)](https://wpmet.com/doc/product-carousel/):** Display multiple products on your WooCommerce website in a slider or carousel form. This WooCommerce product carousel widget of ShopEngine will allow you to create beautiful and dynamic product sliders within a few clicks. You just need to enable the product carousel widget and drag and drop it into the page.
	With this WooCommerce product slider/product carousel widget of ShopEngine, you can showcase a wide variety of products on one page. You can display the price, sale price, ratings, sale badge with percentage, in-stock badge, stock-out badge, star ratings, quick view, add to cart, add to wishlist, and so on. Besides, you can customize the content and styles of every element. 
	Overall, the product carousel of ShopEngine provides a visual representation of the WooCommerce products to lead to higher engagement and conversion rates.

### ✨ SHOPENGINE WOOCOMMERCE GUTENBERG BLOCKS ADD-ON

ShopEngine Gutenberg Addon is an advanced addition to the ShopEngine WooCommerce builder. The ShopEngine Gutenberg addon is compatible with compatible WooCommerce template builders that support Gutenberg. Using this add-on, you can customize the single page, cart page, checkout, archive, etc pages more effectively.

You will get 4 advanced modules, and 5+ templates with 36+ blocks to design your shop as per your needs.

== **4 WooCommerce Modules of ShopEngine Gutenberg Add-on** ==

### 👀 QUICK VIEW

The quick view module of the ShopEngine Gutenberg add-on allows you to provide a quick view option for the WooCommerce products.
When you enable the quick view module of the ShopEngine Gutenberg addon, the customer will see a summary of the selected product in a popup instead of loading the whole website. 

That helps to provide a better user experience to your customers and boost conversion and sales.

### 💖 WISHLIST

The Wishlist Module of the ShopEngine Gutenberg add-on lets the customers add any stockout or unavailable products to their wishlist. Customer can also add their favorite products to the wishlist to purchase the products later. 

By adding products to the “Add to Wishlist” option, they can easily find and purchase when the product will available in your store. 

So far, this Wishlist module of the ShopEngine Gutenberg addon helps customers to get their favorite products and increase sales.

### 🎨 VARIATION SWATCHES

With the variation swatches module of the ShopEngine Gutenberg add-on, you can add multiple options to display a single product based on size, color, price, or other properties. 

This will help to display all varieties of the products to the customers and help them to choose and buy the preferable one. 

Adding this module to the WooCommerce site will help to enhance customer satisfiction as well as scale up your sales and revenue.

### ⚖️ PRODUCT COMPARISON

Enabling the product comparison module of ShopEngine Gutenberg Blocks Add-on will help your potential customers in the decision-making process by comparing multiple options.

Your customer can see the side-by-side comparison for the selected products in a product comparison table. As a result, they can identify the best match and go for the preferable one.

The installation process of the ShopEngine Gutenberg addon is the same and the best part is it’s completely free to use with Gutenberg blocks. 

Overall, using the ShopEngine Gutenberg add-on, you can design a dynamic, fully functional, and fully responsive WooCommerce website for any device (mobile, pc, tab)
...
Added: Compatibility with WooCommerce HPOS(High Performance Order Storeage) issues.
Fixed: Return to shop widget were not showing in empty cart template.
Fixed: Quick view conflict with Eduma theme.
...
v4.2.1 // 18-06-2023
Fixed : After removing products from Cart, it redirect to the blank page issue.
Fixed: Conflict between WooCommerce Notice and Checkout Login form widget in the checkout template.
...
Fixed: Related products query in single product page.
...
Fixed: Unwanted WooCommerce texts on Best Selling Product widget.
...
Fixed: Check color swatch issues on archive products.
Fixed: Redirects to top of div when clicking load more button.
Fixed: WooCommerce Category Showcase lists image not showing.
...
Fixed: Undefined error notice in WooCommerce Product Comparison button.
Fixed: Thank you page preview.
...
Added: New demo WooCommerce template library for Checkout.
...
Fixed: Demo WooCommerce template library preview link and thumbnail missing issue.
...
Added: WooCommerce Extra Product Options Plugin Support.
...
Added: Cart table widget padding, alignment, border, border-radius control.
Added: Cart total widget button width, border control.
Added: Checkout coupon form widget background-color, Space In-between control.
...
Added: Archive product cart buttons gap control
...
Added: New control for WooCommerce Variation Swatches Module
...
Added: Product meta widget label and value typography control.
Added: Payment method widget Input color control.
Added: Checkout Shipping method widget Input color control.
Added: Add to Cart widget Button Hide and Show control.
...
Fixed: WooCommerce Variation Swatches Module width & height issue
...
Added: Icon upload option for WooCommerce responsive grid button in Archive View Mode widget
Added: New style for WooCommerce Category Showcase Products list.
...
v2.2.2 // 18-04-2022
Added: Range WooCommerce slider layout support for Module settings.
...
v2.2.1 // 27-03-2022
Added: RTL sample template in create WooCommerce template library section.
Improved: Performance optimization.
...
Fixed: WooCommerce template library import issue with Unicode Specifically Arabic text.
...
Added: Title, suggested price & action buttons in different positions to recently viewed products and cross-sell product.
...
Fixed: Product image size issue on Single Page Builder.
...
Fixed: Upsell sell duplicate item issue on WooCommerce slider layout.
...
v2.0.0 // 22-01-2022
Added: Ajaxselect2 for filtering except  WooCommerce Category Showcase widget.
...
Improved: WooCommerce Product Tabs widget
...
Fixed: Builder Template filtering Fatal Issue
...
Improved: WooCommerce Product Comparison module code updated.
...
Fixed: fix WooCommerce template library filtering option
...
Fixed: Archive view mode responsive issue
...
Added: WooCommerce Category Showcase widget dropdown color and background color control for advanced WooCommerce AJAX Search Widget.
...
Improved: WooCommerce widgets ordering control numbering to draggable.

v1.5.1 // 18-11-2021
Added: Checkout without account template
...
Fixed: Product Image widget/WooCommerce image gallery responsive issues fixed.
...
v1.4.1 // 07-11-2021
Added: Filter by rating is added in WooCommerce Product List widget
Fixed: Media query does not generated, that's why there are responsiveness issue with smaller device
Fixed: Template redirection issue when previewing from the elementor editor
...
Tweaked: More custom query-loop options in the WooCommerce Product List widget. (now you can make queries by product attributes too)
Tweaked: CSS and JS improved

v1.3.4 // 26-10-2021
Fixed: Elementor optimized asset loading mode issue
Fixed: Elementor builder import css issue
Fixed: Full width layout issue
Fixed: Loop issue for elementor panel issue
Tweaked: Prevented the default edit url for shopengine template
Tweaked: Prevented the default elementor preview url for shopengine template
Tweaked: CSS and JS improved
...
Fixed: Product Reviews widget for WooCommerce responsive issue

v1.3.1 // 10-10-2021
Tweaked: Query updated for Editor View.
Fixed: zIndex issue for Quick Checkout, WooCommerce Quick view and WooCommerce Product Comparison Modal.
...
Fixed: WooCommerce responsive grid Columns support for Archive Products Widget.
Fixed: Toggle on Icon click support for Coupon Form Widget.
Fixed: Advanced Editing Elementor with support for Product Description Widget.
...
Improved: WooCommerce Category Showcase widget based widget representation on Dashboard
Tweaked: CSS and JS improved


v1.2.0 // 22-09-2021
Added: All style added from Elementor control for 'Currency Switcher' Widget.
Added: Dashboard Module Settings page
...
Fixed: Product image widget visual issue.
Fixed: unwanted breadcrumb in the WooCommerce Shop Page Builder and archive page with pagination
Fixed: Some php notices in elementor editor is resolved
...
Improved: WooCommerce template library rendering performance
...
Improved: css for WooCommerce template library editor mode.
...
Fixed: Add to cart widget Porto theme markup conflict.
...
Improved: WooCommerce Quick view, WooCommerce Product Comparison, Woo wishlist, womparison change SVG icon to plugin icon.

v1.0.0 // 23-06-2021
# Ready to use in Production.
Added: Ready to use Starter Templates. More will be added to the collection regularly.
Added: Blank Template support.
Added: General WooCommerce Category and Product List for Site Wide WooCommerce widgets.
...
Improved: Reordered Controls for Product Filters, Archive Products and Advanced Search WooCommerce widgets.
...
Added: WooCommerce Category and Product List Filter option to Filter Widget.
...
Improved: Compare icon, WooCommerce Quick view icon, Plugin icons, loading icon.
...
Improved:  now users can see only the associated WooCommerce widgets to the current template when in editor.
...
7. **WooCommerce Product Wishlist for Elementor.** Let the shoppers add products they like on the Woo wishlist.
...
== ShopEngine Plugin Installation in WordPress==
...
= Why should I choose ShopEngine Pro for my site? =
...
= Do I need add-ons to enjoy ShopEngine? =
...
ShopEngine’s automatic system will send you notifications to renew your license. You can enjoy the features already you have used on your website as well as free features if you don’t renew the license. However, you won’t get the plugin updates and premium support without renewing the license again.
